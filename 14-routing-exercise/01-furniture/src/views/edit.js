...
export async function editView(ctx) {
    ...
    ctx.render(createFormTemp(item)); // Like this we fill the edit form out.
}

// Here we save the changes, after we edit the item.
async function onSubmit(e) {
    ...
    // We sent the 'id' and object with all fields, because the function 'updateById' requires object for the request.

    context.page.redirect('/');
}

// The '.' in front of 'value' add the value to the input field, but hide it like HTML attribute.
